...
public class DataBaseConn {
	...
	/**
	 * @return computer path which indicates the computer location where the .html file of the examined link is saved
	 */
	...
	/** 
	 * This method calls the getConnectionData method, performs the connection to the database using the obtained data
	 * and then inserts the url and file path into the correct column of the created database table
