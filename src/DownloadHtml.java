...
/**
 * Class which performs the connection with the webpage, downloads the source code
 * of the page and writes it into a new file. The name of the file is produced automatically
 * using an object from the Random class. The file is placed in a folder whose name comes
 * from the domain of the webpage.
 *
 * @author Web Masters
 */
...
public class DownloadHtml {
	...
	private static final String[] RANDOM_WORDS = {"roof", "threatening", "hurried", "friend", "chance", "befitting",
	...
	public DownloadHtml(URL url, String path) {
		...
		// comes to a form "C:\Vaggelis\Desktop\DownloadHtml" so we transform it
		// into "C:\Vaggelis\Desktop\DownloadHtml\"
		this.path = path + "\\";
	}
	...
	/**
	 * Method which produces a random file name which has this format:
	 * x000000000 (x: random alphabet letter, 0: random digit 0-9).
